...
class mplPlotter:
    ...
    @staticmethod
    def plot_2d(data, filter = "jet", title = "2d Plot", display_plot = True, save_plot_as_image = True, file_path = "Saved Images/Untitled_2d.png"):
    ...
    def _instance_plot_2d(self, filter = "jet", title = "2d Plot", display_plot = True, save_plot_as_image = True, file_name = "Untitled_2d.png"):
    ...
    @staticmethod
    def plot_3d(data, plot_plane = False, plane_values = np.array([]), filter = "jet", title = "3d Plot", display_plot = True, save_plot_as_image = True, file_path = "Saved Images/Untitled_2d.png"):
        if(data.ndim == 2 and data.size != 0):
    ...
    def _instance_plot_3d(self, plot_plane = False, plane_values = np.array([]), filter = "jet", title = "3d Plot", display_plot = True, save_plot_as_image = True, file_name = "Untitled_3d.png"):
        if(self.data.ndim == 2 and self.data.size !=0):
...
class cv2Helpmate:
    ...
    # void fucntion - saves the data as png image.
    def save(self, file_path = "Saved Images/Untitled_cv2Image.png"):
